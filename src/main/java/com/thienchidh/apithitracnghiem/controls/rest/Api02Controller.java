...
@RestController
@AllArgsConstructor
@RequestMapping("/apiThitracnghiem/02/GiangVien")
public class Api02Controller {
    ...
    public ResponseEntity<UserResponse> login(@RequestBody @NotNull ExamSchedule examSchedule) {
        Account clientAccount = examSchedule.getAccount();
        Exam exam = examSchedule.getExam();
